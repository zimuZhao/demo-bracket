...
(function($, win, undef) {
    ...
    var tipmsg = {
        ...
        w: {
            ...
            "n6-16": "Please fill in 6 to 16 any number！",
            "s": "Can't enter special characters！",
            "s6-18": "Please fill in 6 to 18 character!",
            "p": "Please fill in the zip code！",
            "m": "Please fill in mobile phone numbers！",
            "e": "Wrong email address！",
            "url": "Please fill in URL！"
        },
        def: "Please fill in correct information！",
        undef: "datatype undefined！",
        reck: "The contents of the two entries are inconsistent！",
        r: "Verification of information is passed！",
        c: "Checking…",
        s: "Please {fill in |choose} {0|information}！",
        v: "The information has not been verified. Please wait later…",
        p: "Submitting…"
    }
    $.Tipmsg = tipmsg;
    ...
    Validform.util = {
        ...
        getValue: function(obj) {
            ...
            return Validform.util.isEmpty.call(obj, inputval)
                ? ""
                : inputval;
        },
        ...
        getNullmsg: function(curform) {
            ...
            if (label != "") {
                ...
                nullmsg = obj.is(":checkbox,:radio,select")
                    ? nullmsg.replace(/\{0\|(.+)\}/, "")
                    : nullmsg.replace(/\{0\|(.+)\}/, "$1");
            }
            nullmsg = obj.is(":checkbox,:radio,select")
                ? nullmsg.replace(reg, "$2")
                : nullmsg.replace(reg, "$1");
